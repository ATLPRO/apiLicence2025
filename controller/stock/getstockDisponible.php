...
if (!isset($donnees['idArt']) && !isset($donnees['idmag'])) {
    http_response_code(400);
    echo json_encode(["success" => false, "message" => "id article et magasin manquant."]);
    exit;
}
    ...
    $listedoc = $com->getstockDisponible($donnees['idArt'],$donnees['idmag']);
    if (!empty($listedoc)) {
        ...
        echo json_encode(["message" => "Aucun stock trouvé "]);
    }
} else {
    http_response_code(400);
