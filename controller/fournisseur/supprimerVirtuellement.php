...
if (!isset($donnees['codefour'])) {
    http_response_code(400);
    echo json_encode(["success" => false, "message" => "Code du Fournisseur manquant."]);
    exit;
}
...
try {
    ...
    $resultat = $fournisseur->supprimerVirtuellement($donnees['codefour']);
