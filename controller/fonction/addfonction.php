...
// Créer une instance de la classe fonction
    ...
    $data = json_decode(file_get_contents("php://input"));
     ...
     // Remplir les propriétés de la fonction
    $fonction->intituleFonc = htmlspecialchars($data->intituleFonc);
    
    $result=$fonction->createfonction();
    ...
    if ($result) {
        ...
        echo json_encode(['message' => "Fonction enregistrée avec succès"]);
    } else {
